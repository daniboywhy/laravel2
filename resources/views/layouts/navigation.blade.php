        ...
        <div class="flex justify-between h-16 items-center gap-4">
            ...
            <div class="flex-grow">
                <form action="{{ route('search') }}" method="GET">
                    <input 
                        ...
                        placeholder="Busque por páginas ou categorias..."
                    >
                </form>
            </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @guest
                    ...
                    <a href="{{ route('register') }}" class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 px-3 py-2 text-sm font-medium">
                        {{ __('Register') }}
                    </a>
                @endguest
            </div>
